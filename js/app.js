    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            let onPhoneInput = function(e) {
                let input = e.target;
                let inputNumbersValue = getInpuNumbersValue(input), formattedInputValue = "", selectionStart = input.selectionStart;
                ...
                if ([ "7", "8", "9" ].indexOf(inputNumbersValue[0]) > -1) {
                    ...
                    let firstSybmols = "8" == inputNumbersValue[0] ? "8" : "+7";
            ...
            let onPhoneKeyDown = function(e) {
                let input = e.target;
                if (8 == e.keyCode && 1 == getInpuNumbersValue(input).length) input.value = "";
            };
            let onPhonePaste = function(e) {
                e.clipboardData || window.clipboardData;
                let input = e.target, inputNumbersValue = getInpuNumbersValue(input);
                if (pasted) {
